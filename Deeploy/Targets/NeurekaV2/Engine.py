...
from Deeploy.Targets.Neureka.Parsers import NeurekaRQSDenseConv2DParser, NeurekaRQSDWConv2DParser, \
    NeurekaRQSPWConv2DParser
from Deeploy.Targets.NeurekaV2.Tiler import NeurekaV2RQSDenseConv2DTilingReadyBindings, \
...
neureka_v2_gvsoc_log_activate(neureka_v2_siracusa_get_dev(),
    NEUREKA_V2_GVSOC_LOG_LEVEL_ALL,
    NEUREKA_V2_GVSOC_LOG_FORMAT_HEXADECIMAL);
"""
