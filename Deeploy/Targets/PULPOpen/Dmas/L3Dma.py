...
class L3Dma(AsyncDma):
    ...
    _transferTemplates = {
        2:
            NodeTemplate(
                "pi_cl_ram_copy_2d(get_ram_ptr(), ${ext}, ${loc}, ${transfer_size}, ${stride}, ${length}, ${ext2loc}, &${async_token});"
            )
    }
    _waitingStrategy = PerTensorWaitingStrategy(L3DmaAsyncToken)
