...
from Deeploy.Targets.Generic.Bindings import BasicFloatFusedConv2dReluBinding, BasicFusedAddReluBinding
from Deeploy.Targets.Generic.TileConstraints.AddTileConstraint import AddTileConstraint
from Deeploy.Targets.Snitch.Bindings import SnitchAddBindings, SnitchFloatAddBinding, SnitchGemmBindings, \
...
SnitchFloatFusedAddReluTileReadyBindings = TilingReadyNodeBindings(nodeBindings = [BasicFusedAddReluBinding],
                                                                   tileConstraint = AddTileConstraint())
SnitchFloatFusedConv2dReluTileReadyBindings = TilingReadyNodeBindings(nodeBindings = [BasicFloatFusedConv2dReluBinding],
