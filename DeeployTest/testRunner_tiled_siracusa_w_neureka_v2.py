# ----------------------------------------------------------------------
#
# File: testRunner_tiled_siracusa_w_neureka_v2.py
#
...
if __name__ == "__main__":
    ...
    parser = TestRunnerArgumentParser(
        ...
        description = "Deeploy Code Generation Utility for the Siracusa Platform (Tiling & NEureka_v2).")
    ...
    parser.add_argument('--neureka-wmem',
                        ...
                        action = "store_true",
                        default = False,
                        help = 'Adds weight memory and neureka_v2 engine color\n')
    ...
    testRunner = TestRunner(platform = "Siracusa_w_neureka_v2",
                            simulator = "gvsoc",
                            tiling = True,
